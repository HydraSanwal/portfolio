...
export const projects: Project[] = [
    {
        ...
        description: 'A full-stack Typing Website  built with Next.js, TypeScript, and Tailwind CSS.',
        technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'SupaBase'],
        githubLink: 'https://github.com/HydraSanwal/apetype-main',
        demoLink: 'https://hydratype.vercel.app/',
        image: '/projects/hydratype.png',
      },
      {
